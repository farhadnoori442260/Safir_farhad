          ...
          child: ListView(
            ...
            children: [
              UserAccountsDrawerHeader(
                ...
                accountName: const Text('فرهاد نوری', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16)),
                accountEmail: const Text('+93 7xx xxx xxx', style: TextStyle(color: Colors.white70)),
                currentAccountPicture: const CircleAvatar(
                  backgroundColor: Colors.white,
                  child: Icon(Icons.person, size: 40, color: Color(0xFF145A41)),
                ),
              ),
              ListTile(leading: Icon(Icons.history, color: safirColor), title: const Text('تاریخچه سفرهای من'), onTap: () {}),
